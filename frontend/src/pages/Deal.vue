<template>
  ...
  <div v-if="doc.name" class="flex h-full overflow-hidden">
    <Tabs
      ...
      as="div"
      :tabs="tabs"
      class="flex flex-1 overflow-hidden flex-col [&_[role='tab']]:shrink-0 [&_[role='tablist']]:px-4 [&_[role='tablist']::-webkit-scrollbar]:h-0 [&_[role='tablist']]:min-h-[45px] [&_[role='tablist']]:gap-1.5 [&_[role='tab']_svg]:hidden [&_[role='tabpanel']:not([hidden])]:flex [&_[role='tabpanel']:not([hidden])]:grow"
    >
      <template #tab-panel>
        <Activities
          ref="activities"
